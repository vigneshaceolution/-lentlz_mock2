...
const HomeSection = () => {
  return (
    <div className="relative overflow-x-hidden overflow-y-visible">
      <section className="relative pt-15 pb-20 2xl:pb-48 bg-[#114F3D] lg:bg-transparent">
        {/* Main content */}
        <div className="container mx-auto px-4 2xl:px-8">
          <div className="flex flex-col lg:flex-row items-center">
            ...
            {/* Text Section */}
            <div className="lg:w-1/2 z-10 order-1 lg:order-2 lg:pl-16 xl:pl-50 2xl:pl-80 text-center lg:text-left mb-8 lg:mb-0 2xl:mb-26 2xl:pt-26 relative">
              ...
              <img
                ...
                alt="Side Leaf"
                className="absolute right-0 bottom-5 w-[150px] 2xl:w-[200px] rotate-[-5deg] hidden lg:block lg:-right-5 lg:-bottom-16 2xl:-right-60 2xl:-bottom-70"
              />
            </div>
          </div>
        </div>
