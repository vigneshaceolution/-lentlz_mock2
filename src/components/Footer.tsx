...
const Footer: React.FC = () => {
  return (
    <footer className="text-white py-6 lg:py-12 2xl:py-16 min-h-[100px] 2xl:min-h-[140px] font-[Montserrat] bg-[#100F0D] lg:bg-transparent lg:mt-6 2xl:mt-20">
      <div className="max-w-7xl 2xl:max-w-full mx-auto px-4 sm:px-6 pt-8 sm:pt-12 lg:pt-20 2xl:pt-28 lg:px-20 2xl:px-28 flex flex-col lg:flex-row justify-between items-center">
        {/* Left Side */}
