...
const NewsletterSection: React.FC = () => {
  return (
    <div className="w-full h-full">
      ...
      <div className="max-w-7xl 2xl:max-w-full mx-auto flex flex-col lg:flex-row items-center justify-between px-4 sm:px-6 lg:px-20 2xl:px-28 w-full relative -mb-3 2xl:mb-22">
