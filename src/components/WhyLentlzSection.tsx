const WhyLentlzSection = () => {
  return (
    <div className="pt-10 px-4 md:px-6 md:pb-20 lg:pb-0 lg:px-8 lg:-mt-6 lg:-mb-26 2xl:px-12 2xl:pt-16 2xl:-mt-40 2xl:pb-50 overflow-hidden bg-[#ffaa29] lg:bg-transparent">
      <div className="max-w-7xl 2xl:max-w-9xl mx-auto">
        {/* Header Section */}
        <div className="relative ml-0 md:ml-10 lg:ml-60 2xl:ml-18 mb-8 lg:mb-0 2xl:mb-4">
          <img
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12 2xl:gap-16 pb-11 2xl:pb-16">
          ...
          <div className="lg:col-span-7 lg:ml-20 2xl:ml-0 lg:mt-10 2xl:mt-16 order-2 lg:order-1">
          ...
          {/* Right Side */}
          <div className="lg:col-span-5 order-1 lg:order-2 lg:-mt-20 2xl:-mt-32 lg:mr-8 2xl:mr-12">
            {/* Bowl Section */}
    ...
    2xl:w-[400px] 2xl:h-[400px] 2xl:-bottom-28 2xl:-left-40"
                ...
                <img
                  ...
                  alt="Leaf"
                  className="absolute -right-19 top-50 w-30 h-auto sm:w-10 sm:h-10 lg:w-auto lg:h-80 lg:-right-18 lg:top-70 2xl:-right-30 2xl:top-120 2xl:h-140 md:w-auto md:h-auto md:-right-60"
                />
                <img
