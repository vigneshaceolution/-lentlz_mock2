...
const Header = () => {
  ...
  return (
    <header className="w-full z-50 font-['Montserrat'] pt-2 sm:pt-4 md:pt-6 -mb-1 lg:mb-0 lg:pt-0 xl:pt-10 3xl:pt-16 4xl:pt-20 relative bg-[#114F3D] lg:bg-transparent ">
      <div className="container mx-auto px-2 sm:px-4 md:px-6 lg:px-10 pt-0 xl:px-14 2xl:px-20 3xl:px-28 4xl:px-36 relative">
        ...
        <div className="absolute top-1 left-2 sm:top-2 sm:left-4 md:top-4 md:left-6 lg:top-6 lg:left-8 xl:top-10 xl:left-12 2xl:-left-20 2xl:top-0 3xl:left-40 4xl:left-48 z-40">
          <img
            src="/assets/logo.png"
            alt="Lentlz Logo"
        ...
        {/* Logo */}
        {/* <div className="absolute top-1 left-2 sm:top-2 sm:left-4 md:top-4 md:left-6 lg:top-6 lg:left-8 xl:top-10 xl:left-12 2xl:left-30 3xl:left-40 4xl:left-48 z-40">
          <img
            src="/assets/logo.png"
            alt="Lentlz Logo"
            className="w-[80px] h-[65px] xs:w-[100px] xs:h-[80px] sm:w-[120px] sm:h-[100px] md:w-[140px] md:h-[115px] lg:w-[160px] lg:h-[130px] xl:w-[180px] xl:h-[150px] 2xl:w-[220px] 2xl:h-[180px] 3xl:w-[260px] 3xl:h-[210px] 4xl:w-[300px] 4xl:h-[240px] object-contain"
          />
        </div> */}
